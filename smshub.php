...
class otpkita {
    ...
    public function getBalance() {
        return $this->request(array('api_key' => $this->api_key, 'action' => __FUNCTION__), 'GET');
    }
    
    public function getNumber($service, $country = null, $forward = 0, $operator = null, $ref = null){
        $requestParam = array('api_key' => $this->api_key,'action' => __FUNCTION__,'service' => $service,'forward'=>$forward);
        if($country){
